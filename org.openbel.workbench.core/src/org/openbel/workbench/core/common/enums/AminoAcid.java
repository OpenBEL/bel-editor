package org.openbel.workbench.core.common.enums;

import static org.openbel.workbench.core.common.BELUtilities.sizedHashMap;
import static org.openbel.workbench.core.common.BELUtilities.sizedHashSet;
...
public enum AminoAcid {
    ...
    /**
     * <p>
     * Arginine (abbreviated as Arg or R) is an amino acid. The L-form is one of
     * the 20 most common natural amino acids. At the level of molecular
    ...
    /**
     * <p>
     * Leucine (abbreviated as Leu or L) is a branched-chain amino acid with the
     * chemical formula HO2CCH(NH2)CH2CH(CH3)2. It is an essential amino acid,
     * which means that humans cannot synthesize it. Its codons are UUA, UUG,
     * CUU, CUC, CUA, and CUG. With a hydrocarbon side chain, leucine is
    ...
    /**
     * <p>
     * Phenylalanine (abbreviated as Phe or F) is an amino acid with the formula
     ...
     * 
     * @param s
     *            Amino acid {@link String string} representation
