...
import static org.openbel.workbench.core.common.Strings.*;
...
public enum ExitCode {
    ...
    /* Static cache of enum by value. */
    private static final Map<Integer, ExitCode> INTTOENUM =
            new HashMap<Integer, ExitCode>(values().length, 1F);
     ...
     * 
     * @param s
     *            ExitCode string representation
    ...
    /**
     * Returns the exit code by its integer value.
     * 
     * @param i
     *            {@link ExitCode} value
     * @return {@link ExitCode}
     */
    public static ExitCode getExitCode(final Integer i) {
