...
public enum RelationshipType {
     ...
     * 
     * @param value
     *            {@link Integer}, the value to find an enum instance for
     * @return {@link BELRelationship}, the relationship type, which can be null
     *         if:
     *         <ul>
     *         <li><tt>value</tt> parameter is null</li>
     *         <li><tt>value</tt> parameter does not map to a
     *         {@link RelationshipType}</li>
     *         </ul>
     */
    ...
    public static RelationshipType fromAbbreviation(final String s) {
        ...
        for (final String abbr : ABBRTOENUM.keySet()) {
            if (abbr.equalsIgnoreCase(s))
                return ABBRTOENUM.get(abbr);
        }
     ...
     * 
     * @param s
     *            Relationship type string representation
     ...
     * 
     * @param r
     *            the {@link RelationshipType relationship type}
     * @return boolean
     */
