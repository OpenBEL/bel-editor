...
import static org.openbel.workbench.core.common.enums.FunctionEnum.getFunctionEnum;
import static org.openbel.workbench.core.common.enums.SemanticStatus.*;
import static org.openbel.workbench.core.common.enums.ValueEncoding.getValueEncoding;

import java.io.Serializable;
import java.util.regex.Pattern;

import org.openbel.workbench.core.common.InvalidArgument;
import org.openbel.workbench.core.common.enums.FunctionEnum;
import org.openbel.workbench.core.common.enums.ReturnType;
import org.openbel.workbench.core.common.enums.SemanticStatus;
import org.openbel.workbench.core.common.enums.ValueEncoding;
...
public final class Signature implements Serializable {
     ...
     *             Thrown if the signature is not in the correct format
     */
    ...
    public SemanticStatus matches(final Signature other) {
        ...
        if (getFunction() != other.getFunction())
    ...
    private static String countArgs(final String s) {
        ...
        for (final String arg : argarray)
            if (arg.contains(VARARGS_SUFFIX))
                return "1 or more";
