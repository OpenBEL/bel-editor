...
public class Strings {
     ...
     * {@value}
     */
    public static final String DOCSTORE_CONNECTION_FAILURE = "DocStore connection failure";
     ...
     * {@value}
     */
    public final static String ERROR_DOWNLOADING_RESOURCE = "Error downloading resource";
     ...
     * {@value}
     */
    public static final String IMPORT_DOCUMENT_GROUP = "Optional name of a Document Group in the Document Store to add the BEL Document(s) to. "
     ...
     * {@value}
     */
    public static final String IMPORT_PEDANTIC = "Enables pedantic mode. This mode treats warnings as errors and will terminate the import of a BEL Document "
     ...
     * {@value}
     */
    public static final String KAM_DESCRIPTION_HELP = "A description for the KAM that will be created. Put the description in quotes. It may be necessary "
     ...
     * {@value}
     */
    public static final String LOAD_INDEX_FILE = "Read the index file specified by the URL and cache all resources "
     ...
     * {@value}
     */
    public static final String MISSING_DEP = "Missing dependency";
     ...
     * {@value}
     */
    public static final String NO_GLOBAL_PROTO_NETWORK = "No merged etwork file";
     ...
     * {@value}
     */
    public static final String NO_PHASE_THREE = "Executes Phase III in pass-through mode. This is the same as specifying --no-gene-scaffolding, --no-named-complexes, and --no-protein-families.";
     ...
     * {@value}
     */
    public final static String PEDANTIC_CONVERSION_FAILURE = "Conversion failure";

    /**
     * {@value}
     */
    public final static String PEDANTIC_NAMESPACE_INDEXING_FAILURE = "Namespace indexing failure";

    /**
     * {@value}
     */
    public final static String PEDANTIC_NAMESPACE_RESOLUTION_FAILURE = "Namespace resolution failure";

    /**
     * {@value}
     */
    public final static String PEDANTIC_PROTO_NETWORK_SAVE_FAILURE = "Proto-network save failure";

    /**
     * {@value}
     */
    public final static String PEDANTIC_SEMANTIC_VERIFICATION_FAILURE = "Semantic verification failure";

    /**
     * {@value}
     */
    public final static String PEDANTIC_STATEMENT_EXPANSION_FAILURE = "Statement expansion failure";

    /**
     * {@value}
     */
    public final static String PEDANTIC_SYMBOL_VERIFICATION_FAILURE = "Symbol verification failure";

    /**
     * {@value}
     */
    public final static String PEDANTIC_TERM_EXPANSION_FAILURE = "Term expansion failure";

    /**
     * {@value}
     */
    public final static String PEDANTIC_VALIDATION_FAILURE = "Validation failure";
     ...
     * {@value}
     */
    public static final String PHASE_1_DOCSTORE_DOCUMENT_GROUP = "Name of a"
            + " document group in the BEL Document Store that contains one"
            + " or more BEL documents to compile.";

    /**
     * {@value}
     */
    public static final String PHASE_1_INPUT_FILE = "File name of an XBEL or BEL Script file to compile.";
     ...
     * {@value}
     */
    public final static String PHASE2_STAGE3_HDR = "Equivalencing merged network";
     ...
     * {@value}
     */
    public final static String PHASE3_STAGE1_HDR = "Processing protein families";
     ...
     * {@value}
     */
    public final static String PHASE3_STAGE3_HDR = "Processing gene scaffolding";

    /**
     * {@value}
     */
    public final static String PHASE3_STAGE4_HDR = "Equivalencing merged network";
     ...
     * {@value}
     */
    public final static String RC_READ_FAILURE = "Failed to read runtime configuration";
     ...
     * {@value}
     */
    public final static String SEMANTIC_NESTED_REQUIRE_CAUSAL = "nested statements require causal relationships";

    public final static String SEMANTIC_MULTI_NESTED = "statements with multiple nesting are not valid";
     ...
     * {@value}
     */
    public final static String SEMANTIC_STATEMENT_PROVIDES_RELATIONSHIP = "statement provides relationship when object is missing";

    /**
     * {@value}
     */
    public final static String SEMANTIC_STATEMENT_REQUIRES_RELATIONSHIP = "statement requires relationship when object is present";

    /**
     * {@value}
     */
    public final static String SEMANTIC_TERM_FAILURE = "term failed semantic checks: %s";
     ...
     * {@value}
     */
    public final static String SYSCFG_READ_FAILURE = "Failed to read system configuration";
    ...
    public static final String SYSTEM_CONFIG_PATH = "Optional. Allows the"
            ...
            + " to use to specify the BEL Framework configuration.\n"
     ...
     * {@value}
     */
    public static final String RECORDS_PATH_LOCATION = "records";

    /**
     * {@value}
     */
    public static final String QUERY_VALUE_URL_ENTITY_PLACEHOLDER = "[VALUE]";
